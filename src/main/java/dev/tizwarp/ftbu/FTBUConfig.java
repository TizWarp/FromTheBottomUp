...
@Config(modid = FTBU.MODID, name = "FTBUmod/FTBUmod")
public final class FTBUConfig {
    ...
    @Mod.EventBusSubscriber(modid = FTBU.MODID)
    public static final class ConfigReloadListener {
        ...
        public static void onChanged(ConfigChangedEvent.OnConfigChangedEvent ev) {
            if(ev.getModID().equals(FTBU.MODID)) {
                ConfigManager.sync(FTBU.MODID, Config.Type.INSTANCE);
